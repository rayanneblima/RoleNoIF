...
public class AgendarVisita extends AppCompatActivity {
    ...
    private void exibirForm() {
        ...
        mWebView.loadUrl("https://docs.google.com/forms/d/e/1FAIpQLSfIMU-N4Z5TvrgYxEytMatgxAJPZ4U5L88BSZEYCORK7onzFw/viewform?usp=sf_link");        mWebView.setWebViewClient(new WebViewClient(){
            @Override
