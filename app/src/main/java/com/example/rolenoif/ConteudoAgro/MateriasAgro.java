...
public class MateriasAgro extends AppCompatActivity {
    ...
    private void pegaCurso() {
        ...
        if (nomeCurso.equals(com.example.rolenoif.TesteVocacional.DescricaoCursos.getnomeCursos(1))){
            inicializar();
            exibirVideo();
            mostraConteudo();
            textView2.setText("MATÉRIAS - " + nomeCurso);
            textView3.setText(com.example.rolenoif.TesteVocacional.DescricaoCursos.getmateriascursos1(1));
            textView4.setText(com.example.rolenoif.TesteVocacional.DescricaoCursos.getmateriascursos2(1));
            textView5.setText(com.example.rolenoif.TesteVocacional.DescricaoCursos.getmateriascursos3(1));
            ...
            mostraConteudo();
            textView2.setText("MATÉRIAS - " + nomeCurso);
            textView3.setText(com.example.rolenoif.TesteVocacional.DescricaoCursos.getmateriascursos1(2));
            textView4.setText(com.example.rolenoif.TesteVocacional.DescricaoCursos.getmateriascursos2(2));
            textView5.setText(com.example.rolenoif.TesteVocacional.DescricaoCursos.getmateriascursos3(2));
            ...
            mostraConteudo();
            textView2.setText("MATÉRIAS - " + nomeCurso);
            textView3.setText(com.example.rolenoif.TesteVocacional.DescricaoCursos.getmateriascursos1(3));
            textView4.setText(com.example.rolenoif.TesteVocacional.DescricaoCursos.getmateriascursos2(3));
            textView5.setText(com.example.rolenoif.TesteVocacional.DescricaoCursos.getmateriascursos3(3));
            ...
            mostraConteudo();
            textView2.setText("MATÉRIAS - " + nomeCurso);
            textView3.setText(com.example.rolenoif.TesteVocacional.DescricaoCursos.getmateriascursos1(4));
            textView4.setText(com.example.rolenoif.TesteVocacional.DescricaoCursos.getmateriascursos2(4));
            textView5.setText(com.example.rolenoif.TesteVocacional.DescricaoCursos.getmateriascursos3(4));
